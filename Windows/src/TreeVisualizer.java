...
public class TreeVisualizer {
    private static class libNames {
        public static final String odgfFileName = "libOGDF.dll";
        public static final String tmapFileName = "libtmap.dll";
        public static final String functionFileName = "libLayoutFromEdgeList_internal.dll";
    }
