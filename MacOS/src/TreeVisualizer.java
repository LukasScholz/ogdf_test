...
public class TreeVisualizer {
    private static class libNames {
        public static final String odgfFileName = "libOGDF.dylib";
        public static final String tmapFileName = "libtmap.dylib";
        public static final String functionFileName = "libLayoutFromEdgeList_internal.dylib";
    }
